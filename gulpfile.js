...
gulp.task('build:dev', ['jade', 'less', 'templates', 'styles', 'concat', 'post-process', 'allassets'])
gulp.task('build', ['clean', 'build:dev', 'minify'])

gulp.task('default', ['start', 'build:dev'])
